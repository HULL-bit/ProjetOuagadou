      ...
      navigator.geolocation.getCurrentPosition(
        (position) => {
          ...
          createAlert({
            userId: user!.id,
            type: 'emergency',
            message: `🚨 ALERTE URGENCE - ${user!.profile.fullName} demande assistance immédiate`,
            location: {
        ...
        () => {
          ...
          createAlert({
            userId: user!.id,
            type: 'emergency',
            message: `🚨 ALERTE URGENCE - ${user!.profile.fullName} demande assistance immédiate (position non disponible)`,
            severity: 'critical'
          });
        }
      );
